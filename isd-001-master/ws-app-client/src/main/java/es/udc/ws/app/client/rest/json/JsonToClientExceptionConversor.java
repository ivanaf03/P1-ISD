...
public class JsonToClientExceptionConversor {
    ...
    public static Exception fromForbiddenErrorCode(InputStream ex) throws ParsingException {
        try {
            ...
            if (rootNode.getNodeType() != JsonNodeType.OBJECT) {
                ...
                String errorType = rootNode.get("errorType").textValue();
                if (errorType.equals("InvalidCC")) {
                    return toInvalidCreditCardException(rootNode);
                } else {
                    throw new ParsingException("Unrecognized error type: " + errorType);
                }
            }
    ...
    private static ClientInvalidCreditCardException toInvalidCreditCardException(JsonNode rootNode) {
        return new ClientInvalidCreditCardException();
    }
    ...
    public static Exception fromGoneErrorCode(InputStream ex) throws ParsingException {
        try {
            ...
            if (rootNode.getNodeType() != JsonNodeType.OBJECT) {
                ...
                String errorType = rootNode.get("errorType").textValue();
                if (errorType.equals("NoTickets")) {
                    return toNoTicketsException();
                } else if (errorType.equals("GameCelebrated")) {
                    return toGameCelebratedException();
                } else {
                    throw new ParsingException("Unrecognized error type: " + errorType);
                }
            }
    ...
    private static ClientGameCelebratedException toGameCelebratedException() {
        return new ClientGameCelebratedException();
    }

    private static ClientNoTicketsException toNoTicketsException() {
        return new ClientNoTicketsException();
    }
    ...
    public static Exception fromConflictErrorCode(InputStream ex) throws ParsingException {
        try {
            ...
            if (rootNode.getNodeType() != JsonNodeType.OBJECT) {
                ...
                String errorType = rootNode.get("errorType").textValue();
                if (errorType.equals("TicketsDelivered")) {
                    return toTicketsAlreadyDelivered(rootNode);
                } else {
                    throw new ParsingException("Unrecognized error type: " + errorType);
                }
            }
    ...
    private static ClientTicketsAlreadyDeliveredException toTicketsAlreadyDelivered(JsonNode rootNode) {
        return new ClientTicketsAlreadyDeliveredException();
    }
